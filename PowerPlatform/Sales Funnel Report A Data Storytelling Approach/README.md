...
- Percentages at each stage must be calculated relative to the starting number of leads, so drop-off is always shown accurately, and all visuals must update together and consistently whenever a filter is applied.
...
**Lessons learned:**
- Choosing the right visual, a funnel rather than a plain table, makes a multi-stage process far easier to understand at a glance.
